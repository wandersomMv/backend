...
class Extracao_dados:
    ...
    def coleta_nome_arquivos(self):
        self.caminhos_arquivos = os.getcwd()
        self.caminhos_arquivos = self.caminhos_arquivos.replace('Controller','')
        self.caminho_ate_pasta_downloads += self.caminhos_arquivos + "Downloads/"
